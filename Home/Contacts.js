...
function Home({navigation})   {
  ...
  return(
    <View style={{flexGrow:1,height:'100%',backgroundColor:'white'}}>
        ...
        <View style={{bottom:90,backgroundColor:'white'}}>
            <ImageBackground 
                source={image}
            ...
            >
                ...
                <View style={styles.scachContainer}>
                    <Text style={styles.userGreet}>Hi Ritesh,</Text>
        ...
        <View style={{flex:1}}>
        <View style={{backgroundColor:'white',bottom:70,justifyContent:'space-between',padding:19,flexDirection:'column',height:420}}>
            <TouchableOpacity onPress={goToWhatsapp}>
                                    <Image source={Whats}
                                        style={{width:width-40,marginRight:8, height:100,borderRadius:10,}}
                                    />
                                    <Text style={styles.ImageText}>Whats</Text> 
                                </TouchableOpacity>
